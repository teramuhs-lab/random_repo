...
Configuration 'CreateAGListener' {
        ...
        if ($ConfigurationData.NonNodeData.HADR.SQLAAGBuild -eq 'Yes') {
            ...
            if ( $Node.Role -eq 'PrimaryReplica' ) {
                ...
                xSQLServerAvailabilityGroupListener AddAGListener {
                            ...
                            DependsOn               = '[xWaitForAvailabilityGroup]AGWait'
...
#Create MoF file
CreateAGListener -ConfigurationData $envData -OutputPath $mofLocation 
...
if ($Deploy) {
    ...
    #Remove-DscConfigurationDocument -CimSession ($envData.AllNodes.NodeName | where-object {$Node.Role -eq 'PrimaryReplica'})
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdHUR9Mo9QTSTR
# cEKAGgvAD3jVnuZXGFtQUz0PdctMXKCCFJQwggo1MIIIHaADAgECAgRRsGn6MA0G
...
# CQQxIgQgxXm0Spz58yHmDfn3QTXkQCmsBTAgUBMNPoUwjBHp5bowDQYJKoZIhvcN
# AQEBBQAEggEAVjqDcoGwoLV+Yk4xUknTE/uI8SMux2bRbMKOtAxOcymNayH9lAId
# EibaBTlqhxH8lNnALE0mOMi/fZSbUiPKdPAQ06asnEwORsTXn1YXmMelNVDXwGfJ
# vPmm/Pn5QKlrmgY8GKKDlvb043Bt7A7GQ3wDC3M5RgzvOdfIQvFoR+gWTN7npUlK
# G5vscm0oThoTECLJUEewoyStZ+fwcVJEtugIJJZikVvyUfySlaRi6tONkB0ET77b
# 32/8iVlUAxh/F8n/nzTtcv7JLe2CanKz7GqRdhkBkD1CstwY+nYdhzvLfaBBGWaN
# GFI7mt5wim3Yk8bq7RUKOprkCC00gxy5WA==
