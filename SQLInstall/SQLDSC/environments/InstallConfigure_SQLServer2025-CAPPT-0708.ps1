@{
    ...
    NonNodeData = @{
        ...
        SQL  = @{
            ...
            SQLSysAdminAccounts   = 'MS\NPE-SQLAdmins','NPE-SO-DBAs'                            # The Installer domain account and SQL Server DBA domain group have sysadmin rights
