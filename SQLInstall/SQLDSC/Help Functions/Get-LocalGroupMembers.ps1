...
#>
	...
	# Define an array to store the results in
	$members = @()
	...
	foreach ( $computer in $ComputerName )
	{
		...
		{
			if([ADSI]::Exists("WinNT://$computer/$localGroup,group"))
			{
				...
				$name = $a[-1]
				$domain = $a[-2]
				$class = $groupMember.GetType().InvokeMember('Class', 'GetProperty', $null, $groupMember, $null)

				$member = New-Object PSObject
					$member | Add-Member -MemberType NoteProperty -Name 'Computer' -Value $computer
					$member | Add-Member -MemberType NoteProperty -Name 'Group' -Value $localGroup
	...
	# Return the results
	$members | select Computer,Group,Domain,Name,Class
}
# SIG # Begin signature block
# MIIXtQYJKoZIhvcNAQcCoIIXpjCCF6ICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQnJfJxR5kmbqP
# GJdlZIbouPhaVSOZ11gWpIhRIj3VDKCCFJQwggo1MIIIHaADAgECAgRRsGn6MA0G
...
# CQQxIgQgoRrhJ9MMyEGJID/S7ZydDO+2iE5tMBaqkg5IWsLaN+wwDQYJKoZIhvcN
# AQEBBQAEggEAByxLI347Kkgv6567qBw1fsjlpOmzr+ghcxqxxs7N9S7Mzq0DSRJx
# cqsxkTyOSyY5K32a7GNyTSXkvgQnfB9MPbb+RXIDoWImSwhu6zuez07W910RQv4A
# gJF0m+LTHXNfvwDoNNkqUtQ6UZ5iaaNxRxkAVHyQLFo43T260F3XXI6Qpa1IYdOz
# LGh/LW43NLE+kIFCfGKaCGktih5rNY7weJN7/IccsVATVHR189z7skhA33L1SNSc
# jKw2NgWd5MRCDWaJVGbTllTppsRMD7On7fQXjab1zYLQenf5NnFzKWsLlR5o4A3l
# H+/fnMktOqYz3TRqqTmqg/EuQkmed2Op6A==
