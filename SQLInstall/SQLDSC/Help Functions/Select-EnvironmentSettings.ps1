...
#>
	...
	(
		...
		[string]$settingsPath = '.\Environments'
	)

	# Get all of the settings files except for the templates and examples
	$excludeSettingsFiles = @(
		'*Template.ps1'
		'*Example.ps1'
	)
	[array]$allSettingsFiles = Get-ChildItem -Path $settingsPath -Exclude $excludeSettingsFiles

	# Allow the user to select which settings they want
	[array]$selectedSettings = $allSettingsFiles | Select-Object -ExpandProperty BaseName | Out-GridView -Title 'Select the desired environments' -OutputMode Multiple

	# Get the file names of those settings
	[array]$selectedSettingsFiles = Get-ChildItem -Path $settingsPath | Where-Object { $selectedSettings -contains $_.BaseName }

	return $selectedSettingsFiles
}
# SIG # Begin signature block
# MIIXtQYJKoZIhvcNAQcCoIIXpjCCF6ICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7rK3FrJY0wT4i
# +iFn0uRJ+VwEcwmqUSQx9+JBN70IbqCCFJQwggo1MIIIHaADAgECAgRRsGn6MA0G
...
# CQQxIgQglbesLvu4cBCgMfvX5LYY5rb63vpVRhR7SE5WedBQVzswDQYJKoZIhvcN
# AQEBBQAEggEAtAfLPW59JwAf4G2zFCy+l4yt2J/ehu8JHqXuDwQzZyjQarnldn1U
# KRmRlrIyQtL9ml7b3hDNge+HCB/Eug/hs3yS8byjEDtU6RqqgtiCKibpF+gHNCnG
# 8VHowGTrjfw3n5r0zj/10IeVIP7gx77nfhTPGq6UUgvbUqjsyGRrf+vJHMuJK9d0
# owjs/5cswRyvu5f8J1fFkAFeGkQmgynMOp3aJ4AU3ZOplvQZoyV6rwQh/RosQNMU
# te9aGvOQR7tJIZFNSujS1lMyAkjZOB6OFHbE4fnwoBqD1eQlQW4afNXHiGTq7LAW
# 4wzBZNkBCqPHIgxgkysz3UCWQfrl8olApw==
