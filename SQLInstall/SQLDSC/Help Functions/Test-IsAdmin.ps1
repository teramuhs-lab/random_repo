...
#>
    ...
    ## If we're not running as admin
    if ( -not $currentPrincipal.IsInRole( [Security.Principal.WindowsBuiltInRole]::Administrator ) )
    {
        # Copy the command that was executed
		(Get-History)[-1].CommandLine | clip
		Write-Host 'Last command copied to the clipboard.' -ForegroundColor Green
		
		## Exit the script throwing an error
        throw 'Not running as Administrator.  Please re-start the script as Administrator.'
    }
}
# SIG # Begin signature block
# MIIXtQYJKoZIhvcNAQcCoIIXpjCCF6ICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDwfAh+BDRUJAeS
# Kk1q6Hatu3owTAnUl0ldEaCkC1sRXKCCFJQwggo1MIIIHaADAgECAgRRsGn6MA0G
...
# CQQxIgQgHgoxXI7ZGN9dEhUTjw3A3qvWLigES7iQgYSd/YoQXlswDQYJKoZIhvcN
# AQEBBQAEggEAPFRsPBzpCP015L7iAoT2ZA+DhubAHtoKK6tQLmklnGQ48hM9evov
# j1hDqAs09k6eE/zF8FYYRKUQXm5jyjgIsCWOliPtvt/sJ4X4yrpTF2aHA7Mkpymj
# Mz1sPv8zRix0Ja8qbHZb9pIic9LT8oZhqtEw7bObHY1jt54KT7QC0fBEZVBqY96r
# 9qWldFMcgAsiZcT045ENzP7n4QUNLVP/p28zpEHtCvfn5TxWhlg/mAoye7VDSlN2
# uIYJRKyqobCwo3khuHMkhOUucDXICIoVzi/iOIyXCMGv+ofU0e3oHHmk3EvmEquV
# dbJNNb5Qym10kus6DF3UGADKW+viz6+Tsg==
